...
/**
 * Draws pdf-escroto model annotations directly into page content streams.
...
class PdfAnnotationFlattener {
    ...
    private void drawImage(PDDocument document, PDPageContentStream content, ImageAnnotation ia) throws IOException {
        ...
        var pdImage = PDImageXObject.createFromByteArray(document, imageData, "pdf-escroto-image");
